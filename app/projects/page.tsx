        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              <h1 className="text-4xl font-bold text-white tracking-tight mb-3">All Projects</h1>
        ...
        <div className="bg-zinc-900 border border-zinc-600 rounded-3xl overflow-hidden shadow-2xl">
          <table className="w-full">
            <thead className="bg-zinc-950 border-b border-zinc-800">
              <tr>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">PROJECT #</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">CUSTOMER</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">PROJECT NAME</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">APPROVAL</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">COMPLETE</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">INVOICED</th>
                <th className="px-8 py-5 text-left text-xs font-medium text-zinc-400 uppercase tracking-widest">P&amp;L MARGIN</th>
              ...
              {projects.map((p) => (
                <tr key={p.id} className="hover:bg-blue-600/80 transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    {p.customer_approval && (
                      <span className={`inline-flex items-center px-4 py-1 rounded-full text-xs font-semibold ring-1 ring-inset
                  ...
                  <td className="px-8 py-6">
                    <Link href={`/projects/${p.id}`} className="flex items-center gap-2 text-blue-400 hover:text-blue-300 group-hover:text-blue-400 transition-colors">
