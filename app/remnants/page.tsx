    ...
    <div className="min-h-screen bg-zinc-950 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              <h1 className="text-4xl font-bold text-white tracking-tight mb-3">Remnant Tracker</h1>
              ...
              <p className="text-zinc-600 text-lg text-center">Track remnant inventory and optimize material usage</p>
            </div>
          </div>
        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-3xl p-12 text-center shadow-2xl min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <p className="text-xl text-zinc-400 mb-8 max-w-2xl">Remnant Tracker: Log scrap materials, track inventory, assign to projects, and minimize waste with smart reuse suggestions.</p>
          <div className="bg-gradient-to-r from-purple-600/20 to-purple-700/20 border border-purple-500/30 rounded-3xl p-8 shadow-[0_15px_35px_rgba(168,85,247,0.2)]">
            <p className="text-2xl font-mono text-purple-400 mb-2">Log • Inventory • Reuse • Waste Analytics</p>
            <p className="text-lg text-purple-300">Scrap → Value: Track, Reuse, Reduce Waste</p>
          </div>
        </div>
      </div>
    </div>
