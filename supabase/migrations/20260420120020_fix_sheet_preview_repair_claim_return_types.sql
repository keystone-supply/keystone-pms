...
create function public.claim_sheet_preview_repair_jobs(
...
begin
  ...
  select
    u.id::bigint as job_id,
    u.sheet_stock_id::uuid as sheet_stock_id,
    s.svg_path::text as svg_path,
    s.length_in::double precision as length_in,
    s.width_in::double precision as width_in,
    u.attempts::integer as attempts
  from updated u
